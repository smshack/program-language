...
public class Number_Ex {
	...
	public static void main(String[] args) {
		 ...
		 * Integer.valueOf("");
		 * 
		 * Integer.valueOf("34 "); // 숫자 앞, 뒤에 white space문제 Integer.valueOf("A34"); //
		 * 숫자 앞, 뒤에 숫자형 이외의 문자열이 있는 경우 Integer.valueOf("3 4"); // 숫자 중간에 space, 숫자형 이외의
		 * 문자열이 있는 경우 Integer.valueOf("3+4"); // 하나의 문자열이 연산식 처럼 보일때
		 */		
		System.out.println();
		System.out.println();
		System.out.println();
